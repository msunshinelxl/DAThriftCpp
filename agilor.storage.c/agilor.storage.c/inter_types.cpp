...
void DEVICE::__set_id(const int64_t val) {
  this->id = val;
}

const char* DEVICE::ascii_fingerprint = "1CCCF6FC31CFD1D61BBBB1BAF3590620";
const uint8_t DEVICE::binary_fingerprint[16] = {0x1C,0xCC,0xF6,0xFC,0x31,0xCF,0xD1,0xD6,0x1B,0xBB,0xB1,0xBA,0xF3,0x59,0x06,0x20};
...
void TAGVAL::__set_timestamp(const int64_t val) {
  this->timestamp = val;
}

void TAGVAL::__set_state(const int64_t val) {
  this->state = val;
}

void TAGVAL::__set_type(const int16_t val) {
  this->type = val;
}
...
void TAGVAL::__set_hwnd(const int64_t val) {
  this->hwnd = val;
}

void TAGVAL::__set_id(const int64_t val) {
  this->id = val;
}
...
const char* TAGVAL::ascii_fingerprint = "C074D958F71BCFB98527B8D304204C37";
const uint8_t TAGVAL::binary_fingerprint[16] = {0xC0,0x74,0xD9,0x58,0xF7,0x1B,0xCF,0xB9,0x85,0x27,0xB8,0xD3,0x04,0x20,0x4C,0x37};
...
uint32_t TAGVAL::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("state", ::apache::thrift::protocol::T_I64, 3);
  ...
  xfer += oprot->writeFieldBegin("hwnd", ::apache::thrift::protocol::T_I64, 6);
  ...
  xfer += oprot->writeFieldBegin("device", ::apache::thrift::protocol::T_STRING, 8);
...
void TAGNODE::__set_id(const int64_t val) {
  this->id = val;
}

void TAGNODE::__set_type(const int16_t val) {
  this->type = val;
}

void TAGNODE::__set_IOState(const int16_t val) {
  this->IOState = val;
}
...
void TAGNODE::__set_timestamp(const int64_t val) {
  this->timestamp = val;
}

void TAGNODE::__set_state(const int64_t val) {
  this->state = val;
}
...
void TAGNODE::__set_exceptionMin(const int64_t val) {
  this->exceptionMin = val;
}

void TAGNODE::__set_exceptionMax(const int64_t val) {
...
void TAGNODE::__set_interMethod(const bool val) {
  this->interMethod = val;
}

void TAGNODE::__set_hisIndex(const int64_t val) {
  this->hisIndex = val;
}

void TAGNODE::__set_compressMin(const int64_t val) {
  this->compressMin = val;
}

void TAGNODE::__set_compressMax(const int64_t val) {
...
void TAGNODE::__set_creationDate(const int64_t val) {
  this->creationDate = val;
}

const char* TAGNODE::ascii_fingerprint = "E3329B9DCCD0AB0D88898222DFFA3D92";
const uint8_t TAGNODE::binary_fingerprint[16] = {0xE3,0x32,0x9B,0x9D,0xCC,0xD0,0xAB,0x0D,0x88,0x89,0x82,0x22,0xDF,0xFA,0x3D,0x92};
...
uint32_t TAGNODE::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I16) {
          xfer += iprot->readI16(this->IOState);
      ...
      case 19:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->exceptionMin);
      ...
      case 20:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->exceptionMax);
      ...
      case 34:
        if (ftype == ::apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->interMethod);
      ...
      case 35:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->hisIndex);
      ...
      case 36:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->compressMin);
      ...
      case 37:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->compressMax);
...
uint32_t TAGNODE::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("IOState", ::apache::thrift::protocol::T_I16, 6);
  xfer += oprot->writeI16(this->IOState);
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("state", ::apache::thrift::protocol::T_I64, 11);
  xfer += oprot->writeI64(this->state);
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("exceptionMin", ::apache::thrift::protocol::T_I64, 19);
  xfer += oprot->writeI64(this->exceptionMin);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("exceptionMax", ::apache::thrift::protocol::T_I64, 20);
  xfer += oprot->writeI64(this->exceptionMax);
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("interMethod", ::apache::thrift::protocol::T_BOOL, 34);
  xfer += oprot->writeBool(this->interMethod);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("hisIndex", ::apache::thrift::protocol::T_I64, 35);
  xfer += oprot->writeI64(this->hisIndex);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("compressMin", ::apache::thrift::protocol::T_I64, 36);
  xfer += oprot->writeI64(this->compressMin);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("compressMax", ::apache::thrift::protocol::T_I64, 37);
  xfer += oprot->writeI64(this->compressMax);
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("creationDate", ::apache::thrift::protocol::T_I64, 39);
